  ...
  return (
    <div className="preview-card-page">
      ...
      <header className="preview-card-header">
        <Link href={`/cards/${collection}`} className="preview-card-back-btn">
          <ArrowLeft size={18} />
          Back to Collection
        </Link>
        ...
        <div className="preview-card-preview-panel">
                ...
                <div className="card-front">
                  <div className="preview-card-card-mockup theme-copper">
                    <div className="card-face">
                      ...
                      <div className="card-number">●●●● ●●●● ●●●● 4823</div>
          ...
          <div className="preview-card-cta-section">
            <div className="cta-box">
              <h4 className="cta-title">Ready to customize further?</h4>
              <p className="cta-subtitle">Continue to dashboard to finalize your profile settings.</p>
              <button className="cta-button" onClick={() => router.push(`/cards/${collection}/preview-card/dashboard`)}>
